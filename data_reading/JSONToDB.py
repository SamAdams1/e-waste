...
CONNECTION_STRING = f"mongodb+srv://MattEagan:VHvHOrClgsscy5Da@cluster0.us5hu.mongodb.net/?retryWrites=true&w=majority"
...
# class DetectFileChanges(FileSystemEventHandler):
...
# modifyEvent = DetectFileChanges()
# observer = Observer()
# observer.schedule(modifyEvent, path = jsonPath, recursive = False)
# observer.start()

# print("Checking for updates... Press CTRL+C to exit:")
# try:
#     while True:
#         time.sleep(1)
# except:
